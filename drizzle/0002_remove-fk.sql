...
ALTER TABLE "bills" DROP CONSTRAINT IF EXISTS "bills_user_id_users_id_fk";
...
ALTER TABLE "payments" ALTER COLUMN "amount" SET DEFAULT '0.00';-- Custom SQL migration file, put your code below! --